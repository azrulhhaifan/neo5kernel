...
static const struct qpnp_vadc_map_pt adcmap_btm_threshold_14029[] = {
        {-350,  1563}, 
        {-340,  1553}, 
        {-330,  1541}, 
        {-320,  1530}, 
...
static const struct qpnp_vadc_map_pt adcmap_qrd_btm_threshold_14029[] = {
        {-350,  1563}, 
        {-340,  1553}, 
        {-330,  1541}, 
        {-320,  1530}, 
		...
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	bat_voltage = qpnp_adc_scale_ratiometric_calib(adc_code,
			adc_properties, chan_properties);
	//Fanhong.Kong@ProDrv,2014.3.24 add for OTG
	if(is_project(OPPO_14029))
	{
	//pr_err("kongfanhong if(is_project(OPPO_14029))");
	return qpnp_adc_map_temp_voltage(
			adcmap_btm_threshold_14029,
			ARRAY_SIZE(adcmap_btm_threshold_14029),
			bat_voltage,
			&adc_chan_result->physical);
	}
	else
	{
			//pr_err("kongfanhong else  not if(is_project(OPPO_14029))");
		return qpnp_adc_map_temp_voltage(
		...
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	if(is_project(OPPO_14029))
	{
				//pr_err("kongfanhong if(is_project(OPPO_14029))");
	return qpnp_adc_map_temp_voltage(
			adcmap_qrd_btm_threshold_14029,
			ARRAY_SIZE(adcmap_qrd_btm_threshold_14029),
			bat_voltage,
			&adc_chan_result->physical);
			}
	else
